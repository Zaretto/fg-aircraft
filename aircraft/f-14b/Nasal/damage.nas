...
var re_init = func {
  ...
  if (left(getprop("sim/description"),12) == "Grumman F-14") {
    # TODO: move this into other .nas files
...
# this system only work on F14 (from this file anyway):
if (left(getprop("sim/description"),12) == "Grumman F-14") {
...
# this system only work on F14: (Todo: move it into another .nas file)
if (left(getprop("sim/description"),12) == "Grumman F-14") {
  code_ctTimer.start();
}