...
aircraftControlRecipient.Receive = func(notification)
{
    ...
    {
        print("AircraftControlNotification: Set ",notification.EventType, " to ", notification.EventValue, " RIO=",notification.Callsign, " our RIO =",f14.RIO);
        if (notification.Callsign==nil or (f14.RIO != nil and notification.Callsign==f14.RIO)) {
