...
# pylons
pylonI = stations.InternalStation.new("Internal gun mount", 0, [pylonSets.mm20], props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[10]",1));
...
pylon2 = stations.Pylon.new("1B Pylon",      1, [0.4795,-3.2800,-1.5700], pylon2set,  1, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[1]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[1]",1),func{return getprop("payload/armament/fire-control/serviceable") and getprop("fdm/jsbsim/systems/electrics/dc-main-bus")>20;},func{return getprop("sim/model/f-14b/systems/external-loads/station[1]/selected");});
...
pylon4 = stations.Pylon.new("3 Pylon",       3, [-2,0,-1.4333],           pylon4set,  3, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[3]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[3]",1),func{return getprop("payload/armament/fire-control/serviceable") and getprop("fdm/jsbsim/systems/electrics/dc-main-bus")>20;},func{return getprop("sim/model/f-14b/systems/external-loads/station[3]/selected");});
pylon5 = stations.Pylon.new("4 Pylon",       4, [-2,0,-1.4333],           pylon5set,  4, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[4]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[4]",1),func{return getprop("payload/armament/fire-control/serviceable") and getprop("fdm/jsbsim/systems/electrics/dc-main-bus")>20;},func{return getprop("sim/model/f-14b/systems/external-loads/station[4]/selected");});
pylon6 = stations.Pylon.new("5 Pylon",       5, [-2,0,-1.4333],           pylon6set,  5, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[5]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[5]",1),func{return getprop("payload/armament/fire-control/serviceable") and getprop("fdm/jsbsim/systems/electrics/dc-main-bus")>20;},func{return getprop("sim/model/f-14b/systems/external-loads/station[5]/selected");});
pylon7 = stations.Pylon.new("6 Pylon",       6, [-2,0,-1.4333],           pylon7set,  6, props.globals.getNode("fdm/jsbsim/inertia/pointmass-weight-lbs[6]",1),props.globals.getNode("fdm/jsbsim/inertia/pointmass-dragarea-sqft[6]",1),func{return getprop("payload/armament/fire-control/serviceable") and getprop("fdm/jsbsim/systems/electrics/dc-main-bus")>20;},func{return getprop("sim/model/f-14b/systems/external-loads/station[6]/selected");});
